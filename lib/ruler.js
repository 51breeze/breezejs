 ...
 */
const reserved = [
    'static','public','private','protected','internal','package','override','final','as','use',
...
var property_keyword = syntax['private,protected,internal,static,public,override,final,dynamic,abstract']=function(event)
{
    event.prevented=true;
    ...
    this.loop(function(){
        if( 'private,protected,internal,static,public,override,final,dynamic,abstract'.indexOf( this.next.value )<0  && this.next.id !== "(identifier)" )return false;
        n = this.seek();
...
var namespace_keyword = ["let","var","const","function","static","override","final"];
syntax['(identifier)']=function( e )
{
    ...
    if( this.next && this.next.id==="(keyword)" )
    {
        ...
        {
            property_keyword.call(this, {type:this.current.value} );
            return;
        }
    }
