            ...
            if(desc && desc.metatype )
            {
                ...
                switch ( metatype.type )
                {
                    case 'Skin' :
                        ...
                        var skinPakage = makeSkin( metatype , config , defineModules );
                        for( var skinName in skinPakage )
                        {
                            var skinObj = skinPakage[ skinName ];
                            skinContents.push(  skinObj.skin  );
                            styles.push(  skinObj.style  );
                            Utils.merge(requirements, skinObj.requirements );
                        }
                    break;
                }
            }*/
