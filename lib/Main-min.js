...
"constructor":function (jj){this["1484489652414"]={"dispatcher":null,"age":'3',"name":'666 66fff'};
...
this["1484664676658"]={"names":'3'};
var i=50;var items=[];var j=i;var b;
(function(){
for (var i=j;i<60;i++){b=i;var hh=i;__call__("43:38",console,"log",[hh,i]);__call__("44:63",items,"push",[(function(i,hh){ return function (){return i+'---'+hh;}}(i,hh))]);(function(){
if (false){var hh;__call__("49:40",console,"log",[jj]);}
}());
}
}());
__call__("53:33",console,"log",[i,b]);__call__("54:37",this,"tests",[1,2,3,4,5,6]);var c;
for (c in items){__call__("57:56",console,"log",[__call__("57:41",items,c),'====88888']);}__call__("59:58",console,"log",[System.is(this,IProsess),'==========']);},
"implements":[IProsess],
"final":false,
"dynamic":false,
...
var tests;var i;
if (true){i=9;if (a){}}__call__("74:37",console,"log",[a,avg,i]);}},
"cre":{"id":"function","qualifier":"protected","type":"*","value":function (str){if(!System.is(str,String))System.throwError("type","type of mismatch. must is a String");
return __prop__("80:28",this,"bb");}},
