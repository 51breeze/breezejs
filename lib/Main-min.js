...
"constructor":function(jj){Object.defineProperty(this, "1487262590391", {enumerable: false, configurable: false, writable: false, value: {"names":'399999',"uuu":'yhhh',"iu":5,"dd":Array,"_home":'ooooo',"home":"__getter__"}});B.constructor.call(this);
var i;
var date=Main.newInstance("44:36",Date,undefined);var rinningTime=Main.call("45:46",date,"getTime");var ccc=[1,2,3];function cc(){};for(i=0;i<100000;i++){Main.call("54:22",cc,undefined);}var _d=Main.newInstance("57:34",Date,undefined);Main.call("59:47",System,"log",[Main.call("59:30",_d,"getTime")-rinningTime]);},
"implements":[IProsess],
"final":false,
"dynamic":false,
...
"ddcc":{"id":"function","qualifier":"public","type":"*","value":function(){}},
"_home":{"id":"var","qualifier":"private","type":String,"value":'ooooo'},
"home":{"id":"function","qualifier":"public","type":"*","value":{get:function(){Main.call("69:65",System,"log",[System.is(this,IProsess),' the is getter home']);return Main.prop("70:29",this,"_home");}}},
...
var i;
var bb=666;var tests;if(true){(function(){var yy=666;i=9;if(a){}Main.call("88:42",System,"log",['===%s',Main]);}).call(this);}Main.call("90:39",System,"log",[a,avg,i,bb]);return Main.checkType("91:18",Main,this);}},
"cre":{"id":"function","qualifier":"protected","type":"*","value":function(str){if(!System.is(str,String))System.throwError("type","type of mismatch. must is a String");
return Main.prop("97:26",this,"bb");}},
...
return Main.checkType("101:18",String,'');}}
}}, false);
})();
