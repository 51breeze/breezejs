...
var target=__call__("46:45",this,"getProxyTarget"),index=0;while(index<target){events=__call__("50:65",this,["storage","call"],[__prop__("50:63",target,index)]);if(events&&__prop__("51:42",events,type)){return true;}index++;}__call__("57:78",console,"log",[System.instanceof(this,EventDispatcher),'====is even ====']);return false;}},
...
this["1484975596861"]={"names":'3'};
var c;
var b;
var hhhh,yyyy,uu;
var i=50;var items=[];var j=i;var target=1,index=0;for(c in items){__call__("43:56",console,"log",[__call__("43:41",items,c),'====88888']);}(function(){for(var i=j;i<60;i++){b=i;var hh=i;uu=123,hhhh=6899;yyyy=8888888888;__call__("56:38",console,"log",[hh,i]);if(false){(function(i){var hh;__call__("64:42",console,"log",[jj]);__call__("65:71",items,"push",[function(){return i+'---'+hh;}]);}).call(this,i);}}}).call(this);
__call__("70:33",console,"log",[i,b]);__call__("71:37",this,"tests",[1,2,3,4,5,6]);__call__("73:58",console,"log",[System.is(this,IProsess),'==========']);},
"implements":[IProsess],
"final":false,
"dynamic":false,
...
var i;
var tests;if(true){i=9;if(a){}}__call__("88:37",console,"log",[a,avg,i]);}},
"cre":{"id":"function","qualifier":"protected","type":"*","value":function(str){if(!System.is(str,String))System.throwError("type","type of mismatch. must is a String");
return __prop__("94:28",this,"bb");}},
