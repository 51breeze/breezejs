...
var i=50;
    var items=[];
    var j=i;
    var target=1,index=0;
    for (c in items){
        __call__("43:56",console,"log",[__call__("43:41",items,c),'====88888']);
    }
    (function(){
        for (var i=j;i<60;i++){
            b=i;
            ...
            uu=123,hhhh=6899;
            yyyy=8888888888;
            __call__("56:38",console,"log",[hh,i]);
            __call__("57:63",items,"push",[(function(){ return function(){return i+'---'+hh;}}())]);
            if (false){
                var hh;
                __call__("62:40",console,"log",[jj]);
                __call__("64:68",items,"push",[(function(){ return function(){return i+'---'+hh;}}())]);
            }
        }
    }());
    
__call__("68:33",console,"log",[i,b]);__call__("69:37",this,"tests",[1,2,3,4,5,6]);__call__("71:58",console,"log",[System.is(this,IProsess),'==========']);},
"implements":[IProsess],
"final":false,
"dynamic":false,
...
var i;
var tests;if (true){i=9;if (a){}}__call__("86:37",console,"log",[a,avg,i]);}},
"cre":{"id":"function","qualifier":"protected","type":"*","value":function(str){if(!System.is(str,String))System.throwError("type","type of mismatch. must is a String");
return __prop__("92:28",this,"bb");}},
