...
"hasEventListener":{"id":"function","qualifier":"public","type":"*","value":function (type){var target=__call__("46:45",this,"getProxyTarget"),index=0;var events;
while (index<target){events=__call__("50:65",this,["storage","call"],[__prop__("50:63",target,index)]);if (events&&__prop__("51:42",events,type)){return true;}index++;}__call__("57:78",console,"log",[System.instanceof(this,EventDispatcher),'====is even ====']);return false;}},
...
this["1484538769227"]={"names":'3',"bb":null};
var i=50;var items=[];var b;
(function(){
for (var i=i;i<5;i++){b=i;var jj=5;__call__("40:34",console,"log",[i]);__call__("41:54",items,"push",[function (){return i;}]);if (true){__call__("45:40",console,"log",[jj]);}}
}());
__call__("49:36",console,"log",[i,b,jj]);__call__("50:37",this,"tests",[1,2,3,4,5,6]);__call__("52:58",console,"log",[System.is(this,IProsess),'==========']);},
"implements":[IProsess],
"final":false,
"dynamic":false,
...
__call__("58:32",console,"log",[a,avg]);}},
"bb":{"id":"var","qualifier":"private","type":String,"value":null},
"cre":{"id":"function","qualifier":"protected","type":"*","value":function (str){if(!System.is(str,String))System.throwError("type","type of mismatch. must is a String");
return __prop__("64:28",this,"bb");}},
