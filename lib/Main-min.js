...
"constructor":function(jj){Object.defineProperty(this, "1488194528202", {enumerable: false, configurable: false, writable: false, value: {"names":'399999',"uuu":'yhhh',"iu":5,"dd":Array,"_home":'ooooo'}});Reflect.apply(B,this);
Main.apply("67:16",Main.apply("42:41",EventDispatcher,undefined,[document]),"addEventListener",[Main.get("42:71",Event,"READY"),function(e){Main.apply("44:41",System,"log",['=====ready=====']);Main.apply("54:20",Main.apply("46:39",Element,undefined,['#container']),"addEventListener",[Main.get("46:74",MouseEvent,"CLICK"),function(e){Main.apply("48:64",System,"log",['==========style =====event=====']);}]);Main.apply("63:20",Main.apply("56:34",Element,undefined,['#list']),"addEventListener",[Main.get("56:69",MouseEvent,"CLICK"),function(e){Main.apply("58:53",this,"current",[Main.get("58:51",e,"currentTarget")]);Main.apply("61:69",System,"log",['==========%s=====',Main.apply("61:67",this,"property",['id'])]);}]);}]);},
"implements":[IProsess],
"final":false,
"dynamic":false,
...
"home":{"writable":false,"get":function(){Main.apply("80:65",System,"log",[System.is(this,IProsess),' the is getter home']);return Main.get("81:29",this,"_home");}},
...
var i;
var bb=666;var tests;if(true){(function(){var yy=666;i=9;if(a){}Main.apply("99:42",System,"log",['===%s',Main]);}).call(this);}Main.apply("101:39",System,"log",[a,avg,i,bb]);return Main.check("102:18",Main,this);}},
"cre":{"writable":false,"qualifier":"protected","value":function(str){if(!System.is(str,String))System.throwError("type","type of mismatch. must is a String");
Main.apply("109:45",System,"log",[Main.get("109:24",this,"bb"),'====this cre====']);return Main.check("110:18",String,Main.get("110:26",this,"bb"));}},
...
return Main.check("115:18",String,'');}}
}}, false);
})();
