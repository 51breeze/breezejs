...
this["1484490084844"]={"names":'3',"bb":null};
var i=50;var b;
(function(){
for (var i=0;i<5;i++){b=i;__call__("38:34",console,"log",[i]);}
}());
__call__("40:32",console,"log",[i,b]);__call__("41:37",this,"tests",[1,2,3,4,5,6]);__call__("43:58",console,"log",[System.is(this,IProsess),'==========']);},
"implements":[IProsess],
"final":false,
"dynamic":false,
...
__call__("49:32",console,"log",[a,avg]);}},
"bb":{"id":"var","qualifier":"private","type":String,"value":null},
"cre":{"id":"function","qualifier":"protected","type":"*","value":function (str){if(!System.is(str,String))System.throwError("type","type of mismatch. must is a String");
return __prop__("55:28",this,"bb");}},
