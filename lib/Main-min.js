...
"constructor":function (jj){jj=System.typeof(jj) === "undefined" ?'123':jj;
...
"constructor":function (jj){this["1484387462273"]={"dispatcher":null,"age":'3',"name":'666 66fff'};
__call__("38:23",this,[D],[jj]);var cc=66;},
"implements":[],
"final":false,
"dynamic":false,
...
__call__("54:37",console,"log",[__prop__("54:35",this,"name")]);__call__("55:36",console,"log",['call cre']);}},
"connect":{"id":"function","qualifier":"public","type":String,"value":function (str){if(!System.is(str,Object))System.throwError("type","type of mismatch. must is a Object");
return '';}}
}});
__prop__=B.prop;
__call__=B.call;
...
"constructor":function (target){Object.constructor.call(this);
...
"hasEventListener":{"id":"function","qualifier":"public","type":"*","value":function (type){var target=__call__("46:45",this,"getProxyTarget"),index=0;while (index<target){var events=__call__("50:65",this,["storage","call"],[__prop__("50:63",target,index)]);if (events&&__prop__("51:42",events,type)){return true;}index++;}__call__("57:78",console,"log",[System.instanceof(this,EventDispatcher),'====is even ====']);return false;}},
"addEventListener":{"id":"function","qualifier":"public","type":System.define("lib.EventDispatcher"),"value":function (type,callback,useCapture,priority,reference){var len=__prop__("70:31",type,"length");if (System.instanceof(type,Array)){while (len>0)__call__("75:106",this,"addEventListener",[__prop__("75:66",type,--len),callback,useCapture,priority,reference]);return this;}if (System.typeof("79:27",type)!=='string'){throw System.new("81:54",Error,['invalid event type.']);}var target=__call__("84:45",this,"getProxyTarget"),index=0;var listener=System.new("86:93",EventDispatcher,"Listener",[callback,useCapture,priority,reference]);var bindBeforeProxy;while (index<__prop__("89:41",target,"length")){__prop__("91:35",listener,"dispatcher",this);__prop__("92:38",listener,"currentTarget",__prop__("92:52",target,index));__prop__("93:29",listener,"type",type);if (!(System.instanceof(__prop__("94:43",bindBeforeProxy,type),__prop__("94:83",EventDispatcher,"SpecialEvent")))||!__call__("95:71",bindBeforeProxy,[type,"callback","call"],[this,listener])){}index++;}return this;}},
"removeEventListener":{"id":"function","qualifier":"public","type":"*","value":function (type,listener){var target=__call__("114:45",this,"getProxyTarget");var b=0;var removeEventListener;while (b<__prop__("117:36",target,"length")){__call__("119:70",removeEventListener,"call",[__prop__("119:50",target,b),type,listener,this]);b++;}return true;}},
...
"constructor":function (jj){this["1484402201250"]={"names":'3',"bb":null};
var ii={"name":{},"age":1};__prop__("40:19",ii,"cc",666);var bb=function (){};__call__("46:18",bb);var b,c='uuuu',d=6;var name=null;__call__("51:26",this,[B],['666']);__call__("52:41",console,"log",[__prop__("52:39",Main,"classname")]);__call__("53:36",console,"log",[__prop__("53:34",this,"names")]);__call__("55:35",this,"cre",[__prop__("55:33",Main,"name")]);},
"implements":[Iprosess],
"final":false,
"dynamic":false,
"filename":"E:\\webroot\\breezejs\\lib\\Main.as",
"static":{
"name":{"id":"var","qualifier":"public","type":String,"value":'5'}
},
"token":"1484402201250",
"extends":B,
"classname":"Main",
...
"cre":{"id":"function","qualifier":"protected","type":"*","value":function (str){if(!System.is(str,String))System.throwError("type","type of mismatch. must is a String");
return __prop__("61:28",this,"bb");}},
"database":{"id":"function","qualifier":"public","type":String,"value":function (name,type){if(!System.is(name,String))System.throwError("type","type of mismatch. must is a String");
if(!System.is(type,Number))System.throwError("type","type of mismatch. must is a Number");
return '';}},
"tests":{"id":"function","qualifier":"public","type":"*","value":function (b,c,d,avg){avg=Array.prototype.slice.call(arguments, 3);
if(!System.is(b,String))System.throwError("type","type of mismatch. must is a String");
var ii=33;}}
}});
__prop__=Main.prop;
__call__=Main.call;
...
/*
for(var block={counter:0,value:{0:{i:0}}}; block.value[0].i<5 ; block.value[0].i++)
{
    block.value[ block.counter ].l = block.value[ block.counter ].i;
    var cc = function () {
         return block.value[ (function(i){return i}(block.counter)) ].l
    }
    block.counter++;
}*/
