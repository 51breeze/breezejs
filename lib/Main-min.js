...
jj=System.typeof(jj) === "undefined" ?jj='123':jj;
...
var i=50;
    ...
    (function(){
        for(var i=j;i<60;i++){
            b=i;
            var hh=i;
            uu=123,hhhh=6899;yyyy=8888888888;
            __call__("56:38",console,"log",[hh,i]);
            if(false){
                (function(i){
                    var hh;
                    __call__("64:42",console,"log",[jj]);
                    __call__("65:71",items,"push",[function(){return i+'---'+hh;}]);
                }).call(this,i);
            }
        }
    }).call(this);
__call__("70:33",console,"log",[i,b]);
    __call__("71:37",this,"tests",[1,2,3,4,5,6]);
    __call__("73:58",console,"log",[System.is(this,IProsess),'==========']);
},
"implements":[IProsess],
"final":false,
"dynamic":false,
...
"cre":{"id":"function","qualifier":"protected","type":"*","value":function(str){return __prop__("94:28",this,"bb");}},
