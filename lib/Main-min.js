...
"constructor":function(jj){Object.defineProperty(this, "1488124021546", {enumerable: false, configurable: false, writable: false, value: {"names":'399999',"uuu":'yhhh',"iu":5,"dd":Array,"_home":'ooooo'}});Reflect.apply(B,this);
Main.apply("61:16",Main.apply("42:41",EventDispatcher,undefined,[document]),"addEventListener",[Main.get("42:71",Event,"READY"),function(e){Main.apply("44:41",System,"log",['=====ready=====']);var elem=Main.apply("45:50",Element,undefined,['#container']);Main.apply("49:20",elem,"addEventListener",[Main.get("46:58",StyleEvent,"CHANGE"),function(e){Main.apply("47:59",System,"log",['==========style event=====']);Main.apply("48:66",System,"log",[Main.get("48:40",e,"property"),Main.get("48:52",e,"oldValue"),Main.get("48:64",e,"newValue")]);}]);Main.apply("56:21",Main.apply("51:34",Element,undefined,['#list']),"addEventListener",[Main.get("51:69",MouseEvent,"CLICK"),function(e){Main.apply("53:53",this,"current",[Main.get("53:51",e,"currentTarget")]);Main.apply("54:68",System,"log",['==========%s=====',Main.apply("54:67",this,"property",['id'])]);}]);Main.apply("57:68",elem,"style",['backgroundColor','rgba(255,0,0,0.6)']);Main.apply("58:53",System,"log",[Main.apply("58:37",elem,"height"),Main.apply("58:51",elem,"width")]);}]);var t=Main.apply("64:42",Main.newin("64:32",Date),"getTime");var d=Main.newin("65:38",Dispatcher);Main.apply("66:42",System,"log",[System.is(d,EventDispatcher)]);var fn=function(e){Main.apply("68:52",System,"log",[Main.get("68:29",e,"type"),'====dispathcer====']);};Main.apply("70:48",d,"addEventListener",['addData',fn]);Main.apply("71:27",d,"addData",[{}]);Main.apply("72:44",System,"log",[Main.apply("72:39",Main.newin("72:29",Date),"getTime")-t]);},
"implements":[IProsess],
"final":false,
"dynamic":false,
...
"home":{"writable":false,"get":function(){Main.apply("86:65",System,"log",[System.is(this,IProsess),' the is getter home']);return Main.get("87:29",this,"_home");}},
...
var i;
var bb=666;var tests;if(true){(function(){var yy=666;i=9;if(a){}Main.apply("105:42",System,"log",['===%s',Main]);}).call(this);}Main.apply("107:39",System,"log",[a,avg,i,bb]);return Main.check("108:18",Main,this);}},
"cre":{"writable":false,"qualifier":"protected","value":function(str){if(!System.is(str,String))System.throwError("type","type of mismatch. must is a String");
Main.apply("115:45",System,"log",[Main.get("115:24",this,"bb"),'====this cre====']);return Main.check("116:18",String,Main.get("116:26",this,"bb"));}},
...
return Main.check("121:18",String,'');}}
}}, false);
})();
