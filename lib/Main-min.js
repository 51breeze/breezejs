 ...
 * @returns {*}
 */
Element.prototype.next=function(elem )
{
...
Element.prototype.getBoundingRect=function(force )
{
    ...
    this.next( Element.getWindow(doc) );
...
})(system,Sizzle);system.window = window;
...
(function(Class,Interface,Number,String,JSON,Object,RegExp,Error,EvalError,RangeError,ReferenceError,SyntaxError,TypeError,URIError,Function,Date,Boolean,Symbol,Iterator,Reflect,Event,EventDispatcher,Array,Math,arguments,window,document,navigator ,location,Element){
(function(){
...
"isAbstract":false,
"proto":{
"addData":{"writable":false,"value":function(val){var e=Dispatcher.new("26:40",Event,['addData']);Dispatcher.apply("28:35",this,"dispatchEvent",[e]);return val;}}
}}, false);
})();
(function(){
...
"constructor":function(jj){Object.defineProperty(this, "1488042815056", {enumerable: false, configurable: false, writable: false, value: {"names":'399999',"uuu":'yhhh',"iu":5,"dd":Array,"_home":'ooooo'}});Reflect.apply(B,this);
Main.apply("49:16",Main.apply("43:39",EventDispatcher,undefined,[window]),"addEventListener",[Main.get("43:69",Event,"READY"),function(e){Main.apply("45:41",System,"log",['=====ready=====']);var elem=Main.apply("46:43",Element,undefined,['div']);Main.apply("47:44",System,"log",[elem,Main.apply("47:42",elem,"height")]);}]);var t=Main.apply("56:42",Main.new("56:32",Date),"getTime");var d=Main.new("57:38",Dispatcher);Main.apply("58:42",System,"log",[System.is(d,EventDispatcher)]);var fn=function(e){Main.apply("60:52",System,"log",[Main.get("60:29",e,"type"),'====dispathcer====']);};Main.apply("62:48",d,"addEventListener",['addData',fn]);Main.apply("63:27",d,"addData",[{}]);Main.apply("64:44",System,"log",[Main.apply("64:39",Main.new("64:29",Date),"getTime")-t]);},
"implements":[IProsess],
"final":false,
"dynamic":false,
...
"home":{"writable":false,"get":function(){Main.apply("74:65",System,"log",[System.is(this,IProsess),' the is getter home']);return Main.get("75:29",this,"_home");}},
...
var i;
var bb=666;var tests;if(true){(function(){var yy=666;i=9;if(a){}Main.apply("93:42",System,"log",['===%s',Main]);}).call(this);}Main.apply("95:39",System,"log",[a,avg,i,bb]);return Main.check("96:18",Main,this);}},
"cre":{"writable":false,"qualifier":"protected","value":function(str){if(!System.is(str,String))System.throwError("type","type of mismatch. must is a String");
Main.apply("103:45",System,"log",[Main.get("103:24",this,"bb"),'====this cre====']);return Main.check("104:18",String,Main.get("104:26",this,"bb"));}},
