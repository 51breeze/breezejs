...
var __prop__;
var __call__;
D=System.define("com.D",{"constructor":function (jj){jj=System.typeof(jj) === "undefined" ?'123':jj;
if(!System.is(jj,String))throw new TypeError("type of mismatch");
var cc=66;},"implements":[],"final":false,"dynamic":false,"filename":"E:\\nodejs\\breezejs\\lib\\com\\D.as","static":{},"token":"1483493977640","extends":null,"classname":"D","package":"com","proto":{
"address":{"id":"function","qualifier":"protected","type":String,"value":{get:function (){return '66666';},set:function (add){if(!System.is(add,String))throw new TypeError("type of mismatch");
}}},
...
(function(){
var IProt;
IProt=System.define("lib.IProt",{"token":"1484298029453","extends":null,"classname":"IProt","package":"lib","proto":{
...
var IProsess;
IProsess=System.define("lib.IProsess",{"token":"1484297956590","extends":IProt,"classname":"IProsess","package":"lib","proto":{
...
var __prop__;
var __call__;
B=System.define("com.B",{"constructor":function (jj){D.constructor.call(this);
this["1484301955799"]={"dispatcher":null,"age":'3',"name":'666 66fff'};
...
},"token":"1484301955799","extends":D,"classname":"B","package":"com","proto":{
...
"cre":{"id":"function","qualifier":"protected","type":"*","value":function (str){if(!System.is(str,Object))throw new TypeError("type of mismatch");
__call__("53:23",console,"log",[__prop__("53:35",this,"name")]);__call__("54:23",console,"log",['call cre']);}},
"connect":{"id":"function","qualifier":"public","type":String,"value":function (str){if(!System.is(str,Object))throw new TypeError("type of mismatch");
return '';}}
}});
__prop__=B.prop;
__call__=B.call;
...
__prop__("34:50",this,'getProxyTarget'||__prop__("34:48",this,"length"));__prop__("35:31",this,"getProxyTarget",target&&1?function (){return __prop__("37:40",target,"length")>0?target:[this];}:function (){return __prop__("40:50",this,"forEachCurrentItem")?[__prop__("40:77",this,"forEachCurrentItem")]:(__prop__("40:94",this,"length")>0?this:[this]);});},"implements":[],"final":false,"dynamic":false,"filename":"E:\\nodejs\\breezejs\\lib\\lib\\EventDispatcher.as","static":{
"Listener":{"id":"var","qualifier":"public","type":Class,"value":B},
"SpecialEvent":{"id":"var","qualifier":"public","type":Class,"value":B}
},"token":"1483946649562","extends":Object,"classname":"EventDispatcher","package":"lib","proto":{
...
"hasEventListener":{"id":"function","qualifier":"public","type":"*","value":function (type){var target=__call__("46:43",this,"getProxyTarget"),index=0;while (index<target){var events=__call__("50:46",this,["storage","call"],[__prop__("50:63",target,index)]);if (events&&__prop__("51:42",events,type)){return true;}index++;}__call__("57:23",console,"log",[System.instanceof(this,EventDispatcher),'====is even ====']);return false;}},
"addEventListener":{"id":"function","qualifier":"public","type":System.define("lib.EventDispatcher"),"value":function (type,callback,useCapture,priority,reference){var len=__prop__("70:31",type,"length");if (System.instanceof(type,Array)){while (len>0)__call__("75:53",this,"addEventListener",[__prop__("75:66",type,--len),callback,useCapture,priority,reference]);return this;}if (System.typeof("79:27",type)!=='string'){throw System.new("81:31",Error,['invalid event type.']);}var target=__call__("84:43",this,"getProxyTarget"),index=0;var listener=System.new("86:53",EventDispatcher,"Listener",[callback,useCapture,priority,reference]);var bindBeforeProxy;while (index<__prop__("89:41",target,"length")){__prop__("91:35",listener,"dispatcher",this);__prop__("92:38",listener,"currentTarget",__prop__("92:52",target,index));__prop__("93:29",listener,"type",type);if (!(System.instanceof(__prop__("94:43",bindBeforeProxy,type),__prop__("94:83",EventDispatcher,"SpecialEvent")))||!__call__("95:56",bindBeforeProxy,[type,"callback","call"],[this,listener])){}index++;}return this;}},
"removeEventListener":{"id":"function","qualifier":"public","type":"*","value":function (type,listener){var target=__call__("114:43",this,"getProxyTarget");var b=0;var removeEventListener;while (b<__prop__("117:36",target,"length")){__call__("119:40",removeEventListener,"call",[__prop__("119:50",target,b),type,listener,this]);b++;}return true;}},
"dispatchEvent":{"id":"function","qualifier":"public","type":"*","value":function (event){var BreezeEvent;var dispatchEvent;if (!(System.instanceof(event,BreezeEvent))){throw System.new("136:31",Error,['invalid event.']);}var target=__prop__("137:47",this,'getProxyTarget');var targets=__call__("138:54",this,'getProxyTargets',[998]);var i=0;var element;__call__("141:18",target);while (i<__prop__("142:36",target,"length")&&!__prop__("142:65",event,"propagationStopped")){element=__prop__("144:36",target,i);__prop__("145:35",event,"currentTarget",element);__prop__("146:28",event,"target",__prop__("146:43",event,"target")||element);__call__("147:29",dispatchEvent,[event]);i++;}return !__prop__("150:44",event,"propagationStopped");}}
}});
...
var __prop__;
var __call__;
Main=System.define("Main",{"constructor":function (jj){this["1484301942892"]={"names":'3',"bb":null};
var ii={"name":{},"age":1};__prop__("40:19",ii,"cc",666);var bb=function (){__call__("43:29",console,"log",['=====9999====='])};__call__("46:16",bb);var b,c='uuuu',d=6;var name=null;__call__("51:19",this,[B],[jj]);__call__("52:25",console,"log",[__prop__("52:41",Main,"classname")]);__call__("53:25",console,"log",[__prop__("53:37",this,"names")]);},"implements":[Iprosess],"final":false,"dynamic":false,"filename":"E:\\nodejs\\breezejs\\lib\\Main.as","static":{
"name":{"id":"var","qualifier":"public","type":Number,"value":5}
},"token":"1484301942892","extends":B,"classname":"Main","package":"","proto":{
"names":{"id":"var","qualifier":"public","type":String,"value":'3'},
"bb":{"id":"var","qualifier":"private","type":String,"value":null},
"cre":{"id":"function","qualifier":"protected","type":"*","value":function (name){if(!System.is(name,Object))throw new TypeError("type of mismatch");
return __prop__("59:28",this,"bb");}},
"database":{"id":"function","qualifier":"public","type":String,"value":function (name,type){name=System.typeof(name) === "undefined" ?'mysql':name;
if(!System.is(name,String))throw new TypeError("type of mismatch");
if(!System.is(type,Number))throw new TypeError("type of mismatch");
return '';}}
}});
__prop__=Main.prop;
__call__=Main.call;
