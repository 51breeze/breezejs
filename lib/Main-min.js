...
(function(Class,Interface,Number,String,JSON,Object,RegExp,Error,EvalError,RangeError,ReferenceError,SyntaxError,TypeError,URIError,Function,Date,Boolean,Symbol,Iterator,Array,Math,arguments){
(function(){
...
var IProt=System.define("lib.IProt");
var B=System.define("com.B",{
"constructor":function(jj){Object.defineProperty(this, "1486962321138", {enumerable: false, configurable: false, writable: false, value: {"dispatcher":null,"age":'3',"classname":"__getter__","name":'666 66fff'}});B.call("38:23",this,[D],[jj]);var cc=66;B.call("40:53",System,"log",['===the is B====',System.is(this,D)]);},
"implements":[],
"final":false,
"dynamic":false,
"filename":"E:\\webroot\\breezejs\\lib\\com\\B.as",
"static":{
"address":{"id":"var","qualifier":"protected","type":String,"value":'shu line 6666'},
...
var target=EventDispatcher.call("46:45",this,"getProxyTarget"),index=0;while(index<target){events=EventDispatcher.call("50:65",this,["storage","call"],[EventDispatcher.prop("50:63",target,index)]);if(events&&EventDispatcher.prop("51:42",events,EventDispatcher.checkType("51:41",String,type))){return true;}index++;}EventDispatcher.call("57:77",System,"log",[System.instanceOf(this,EventDispatcher),'====is even ====']);return false;}},
"addEventListener":{"id":"function","qualifier":"public","type":System.define("lib.EventDispatcher"),"value":function(type,callback,useCapture,priority,reference,callback,useCapture,priority,reference){var len=EventDispatcher.prop("70:31",type,"length");if(System.instanceOf(type,Array)){while(len>0)EventDispatcher.call("75:106",this,"addEventListener",[EventDispatcher.prop("75:66",type,EventDispatcher.checkType("75:65",String,--len)),callback,useCapture,priority,reference]);return EventDispatcher.checkType("76:22",null,this);}if(System.typeOf(type)!=='string'){throw EventDispatcher.newInstance("81:54",Error,undefined,['invalid event type.']);}var target=EventDispatcher.call("84:45",this,"getProxyTarget"),index=0;var listener=newEventDispatcher.newInstance("86:93",EventDispatcher,"Listener",[callback,useCapture,priority,reference]);var bindBeforeProxy;while(index<EventDispatcher.prop("89:41",target,"length")){EventDispatcher.prop("91:35",listener,"dispatcher",this);EventDispatcher.prop("92:38",listener,"currentTarget",EventDispatcher.prop("92:52",target,index));EventDispatcher.prop("93:29",listener,"type",type);if(!(System.instanceOf(EventDispatcher.prop("94:43",bindBeforeProxy,EventDispatcher.checkType("94:42",String,type)),EventDispatcher.prop("94:83",EventDispatcher,"SpecialEvent")))||!EventDispatcher.call("95:71",bindBeforeProxy,[EventDispatcher.checkType("95:41",String,type),"callback","call"],[this,listener])){}index++;}return EventDispatcher.checkType("102:18",null,this);}},
"removeEventListener":{"id":"function","qualifier":"public","type":"*","value":function(type,listener,listener){var target=EventDispatcher.call("114:45",this,"getProxyTarget");var b=0;var removeEventListener;while(b<EventDispatcher.prop("117:36",target,"length")){EventDispatcher.call("119:70",removeEventListener,"call",[EventDispatcher.prop("119:50",target,b),type,listener,this]);b++;}return true;}},
"dispatchEvent":{"id":"function","qualifier":"public","type":"*","value":function(event){var BreezeEvent;var dispatchEvent;if(!(System.instanceOf(event,BreezeEvent)))throw EventDispatcher.newInstance("136:49",Error,undefined,['invalid event.']);var target=EventDispatcher.prop("137:47",this,'getProxyTarget');var targets=EventDispatcher.call("138:54",this,'getProxyTargets',[998]);var i=0;var element;EventDispatcher.call("141:20",target,undefined);while(i<EventDispatcher.prop("142:36",target,"length")&&!EventDispatcher.prop("142:65",event,"propagationStopped")){element=EventDispatcher.prop("144:36",target,i);EventDispatcher.prop("145:35",event,"currentTarget",element);EventDispatcher.prop("146:28",event,"target",EventDispatcher.prop("146:43",event,"target")||element);EventDispatcher.call("147:38",dispatchEvent,undefined,[event]);i++;}return !EventDispatcher.prop("150:44",event,"propagationStopped");}}
}}, false);
})();
(function(){
var EventDispatcher=System.define("lib.EventDispatcher");
...
"constructor":function(jj){Object.defineProperty(this, "1486963564485", {enumerable: false, configurable: false, writable: false, value: {"names":'399999',"uuu":'yhhh',"iu":5,"dd":Array,"_home":'ooooo',"home":"__getter__"}});B.constructor.call(this);
var uu,yyyy,hhhh;
var b;
var c;
var bb;
var bcc;bcc=Object.prototype.hasOwnProperty.call(this,'uuu');Main.call("47:37",System,"log",[bcc,'++++++uuu ']);Main.call("49:45",System,"log",[Main.call("49:43",System,"isFinite",[Main.prop("49:41",Main,"address")])]);var iv=this;Main.prop("56:21",iv,"iu",undefined,";++");Main.call("58:46",System,"log",[Main.prop("58:31",iv,"iu"),'==========']);Main.prop("60:21",this,"iu",Main.checkType("60:21",Number,6||iv));System.typeOf(!iv);Main.call("67:55",this,"tests",[555,2,3,4,(5+6),6&&6666]);var bc;var an=Main.newInstance("72:39",Array,undefined,[5,6,8]);var iii={};Main.prop("77:22",iii,"name",666);Main.prop("78:21",iii,"yyy",'pppp');Main.call("80:42",System,"log",[iii,'==+++===']);Main.prop("82:29",iii,"name",undefined,"delete");Main.call("84:45",System,"log",[iii,'==------===']);for(bb in Iterator(this,true)){Main.call("90:68",System,"log",[Main.prop("90:39",this,bb),'=================',bb]);}Main.call("93:32",System,"log",[this]);var items=9999,jjj={"name":"666"},ddd;if((items=[]||{},ddd=items,Main.prop("98:26",jjj,"name",ddd))){Main.call("100:42",System,"log",[jjj,ddd,items]);}Main.call("105:38",System,"log",['%s',Main]);var i=50;var j=i;Main.call("113:61",System,"log",[Main.call("113:38",[666],"keys"),Main.call("113:59",System,"trim",[''])]);var a=Main.newInstance("115:38",Array,undefined,[5,6,8]);Main.prop("116:23",a,'name',666);Main.call("118:31",a,"push",['yejun']);var cc={"age":100};Main.prop("122:20",cc,"age",3,"/=");Main.prop("123:19",cc,"bb",66666);Main.call("124:41",System,"log",[cc,Main.prop("124:40",Main,"name")]);var o=Main.newInstance("128:34",Object,undefined);Main.prop("130:23",o,'ssss',666);Main.call("134:124",System,"log",[a,'=====',Main.prop("134:47",a,"length"),Main.call("134:60",a,"values"),Main.call("134:70",o,"keys"),Main.call("134:86",this,"values"),Main.call("134:122",['=======','++++++++++'],"values")]);Main.call("138:17",System,"log",['%s',Main.call("138:16",a,"find",[function(val){return val===666;}])]);var target=1,index=0;for(c in Iterator(items,true)){Main.call("147:55",System,"log",[Main.call("147:40",items,c),'====88888']);}(function(){for(var i=j;i<60;i++){b=i;var hh=i;uu=123,yyyy,hhhh=6899;yyyy=8888888888;Main.call("160:37",System,"log",[hh,i]);if(true){(function(i,hh){Main.call("165:71",items,"push",[function(){return i+'---'+hh;}]);}).call(this,i,hh);}}}).call(this);
(function(){for(var b in Iterator(items,true)){Main.call("174:70",System,"log",['%s=======items==========',Main.call("174:68",items,b)]);}}).call(this);
Main.call("179:57",System,"log",[System.is(this,IProsess),'==========']);},
"implements":[IProsess],
"final":false,
"dynamic":false,
...
"iu":{"id":"var","qualifier":"public","type":Number,"value":5},
"dd":{"id":"var","qualifier":"public","type":Class,"value":Array},
"_home":{"id":"var","qualifier":"private","type":String,"value":'ooooo'},
"home":{"id":"function","qualifier":"public","type":"*","value":{get:function(){Main.call("187:65",System,"log",[System.is(this,IProsess),' the is getter home']);return Main.prop("188:29",this,"_home");}}},
...
var i;
var bb=666;var tests;if(true){(function(){var yy=666;i=9;if(a){}Main.call("206:42",System,"log",['===%s',Main]);}).call(this);}Main.call("208:39",System,"log",[a,avg,i,bb]);return Main.checkType("209:18",Main,this);}},
"cre":{"id":"function","qualifier":"protected","type":"*","value":function(str){if(!System.is(str,String))System.throwError("type","type of mismatch. must is a String");
return Main.prop("215:26",this,"bb");}},
