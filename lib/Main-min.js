...
EventDispatcher.prop("34:50",this,'getProxyTarget'||EventDispatcher.prop("34:48",this,"length"));EventDispatcher.prop("35:31",this,"getProxyTarget",EventDispatcher.checkType("35:31",Function,target&&1?function(){return EventDispatcher.prop("37:40",target,"length")>0?target:[this];}:function(){return EventDispatcher.prop("40:50",this,"forEachCurrentItem")?[EventDispatcher.prop("40:77",this,"forEachCurrentItem")]:(EventDispatcher.prop("40:94",this,"length")>0?this:[this]);}));},
"implements":[],
"final":false,
"dynamic":false,
...
var target=EventDispatcher.call("46:45",this,"getProxyTarget"),index=0;while(index<target){events=EventDispatcher.call("50:65",this,["storage","call"],[EventDispatcher.prop("50:63",target,index)]);if(events&&EventDispatcher.prop("51:42",events,type)){return true;}index++;}EventDispatcher.call("57:77",System,"log",[System.instanceOf(this,EventDispatcher),'====is even ====']);return false;}},
"addEventListener":{"id":"function","qualifier":"public","type":System.define("lib.EventDispatcher"),"value":function(type,callback,useCapture,priority,reference,callback,useCapture,priority,reference){var len=EventDispatcher.prop("70:31",type,"length");if(System.instanceOf(type,Array)){while(len>0)EventDispatcher.call("75:106",this,"addEventListener",[EventDispatcher.prop("75:66",type,--len),callback,useCapture,priority,reference]);return EventDispatcher.checkType("76:22",null,this);}if(System.typeOf("79:27",type,"")!=='string'){throw EventDispatcher.newInstance("81:54",Error,"",['invalid event type.']);}var target=EventDispatcher.call("84:45",this,"getProxyTarget"),index=0;var listener=EventDispatcher.newInstance("86:93",EventDispatcher,"Listener",[callback,useCapture,priority,reference]);var bindBeforeProxy;while(index<EventDispatcher.prop("89:41",target,"length")){EventDispatcher.prop("91:35",listener,"dispatcher",this);EventDispatcher.prop("92:38",listener,"currentTarget",EventDispatcher.prop("92:52",target,index));EventDispatcher.prop("93:29",listener,"type",type);if(!(System.instanceOf(EventDispatcher.prop("94:43",bindBeforeProxy,type),EventDispatcher.prop("94:83",EventDispatcher,"SpecialEvent")))||!EventDispatcher.call("95:71",bindBeforeProxy,[type,"callback","call"],[this,listener])){}index++;}return EventDispatcher.checkType("102:18",null,this);}},
...
"constructor":function(jj){Object.defineProperty(this, "1486566977920", {enumerable: false, configurable: false, writable: false, value: {"names":'399999',"uuu":'yhhh',"_home":'ooooo',"home":"__getter__"}});B.constructor.call(this);
var uu,yyyy,hhhh;
var b;
var c;
var bb;
var bc;var an=Main.newInstance("42:39",Array,"",[5,6,8]);Main.call("43:25",an,"values");Main.call("46:51",this,"tests",[{},2,3,4,(5+6),6&&6666]);for(bb in Iterator(this,true)){Main.call("50:68",System,"log",[Main.prop("50:39",this,bb),'=================',bb]);}Main.call("53:32",System,"log",[this]);var items=9999,jjj={"name":"666"},ddd;if((items=[]||{},ddd=items,Main.prop("58:26",jjj,"name",ddd))){Main.call("60:42",System,"log",[jjj,ddd,items]);}Main.call("65:38",System,"log",['%s',Main]);var i=50;var j=i;Main.call("73:61",System,"log",[Main.call("73:38",[666],"keys"),Main.call("73:59",System,"trim",[''])]);var a=Main.newInstance("75:38",Array,"",[5,6,8]);Main.prop("76:23",a,'name',666);Main.call("78:31",a,"push",['yejun']);var cc={"age":100};Main.prop("82:20",cc,["age","/="],3);Main.prop("83:19",cc,"bb",66666);Main.call("84:41",System,"log",[cc,Main.prop("84:40",Main,"name")]);var o=Main.newInstance("88:34",Object,"");Main.prop("90:23",o,'ssss',666);Main.call("94:124",System,"log",[a,'=====',Main.prop("94:47",a,"length"),Main.call("94:60",a,"values"),Main.call("94:70",o,"keys"),Main.call("94:86",this,"values"),Main.call("94:122",['=======','++++++++++'],"values")]);Main.call("98:17",System,"log",['%s',Main.call("98:16",a,"find",[function(val){return val===666;}])]);var target=1,index=0;for(c in Iterator(items,true)){Main.call("107:55",System,"log",[Main.call("107:40",items,c),'====88888']);}(function(){for(var i=j;i<60;i++){b=i;var hh=i;uu=123,hhhh=6899;yyyy=8888888888;Main.call("120:37",System,"log",[hh,i]);if(true){(function(i,hh){Main.call("125:71",items,"push",[function(){return i+'---'+hh;}]);}).call(this,i,hh);}}}).call(this);
(function(){for(var b in Iterator(items,true)){Main.call("132:70",System,"log",['%s=======items==========',Main.call("132:68",items,b)]);}}).call(this);
Main.call("137:57",System,"log",[System.is(this,IProsess),'==========']);},
"implements":[IProsess],
"final":false,
"dynamic":false,
...
"home":{"id":"function","qualifier":"public","type":"*","value":{get:function(){Main.call("145:65",System,"log",[System.is(this,IProsess),' the is getter home']);return Main.prop("146:29",this,"_home");}}},
...
var i;
var bb=666;var tests;if(true){(function(){var yy=666;i=9;if(a){return Main.checkType("161:26",Main,[]);}Main.call("164:42",System,"log",['===%s',Main]);}).call(this);}Main.call("166:39",System,"log",[a,avg,i,bb]);return Main.checkType("167:18",Main,this);}},
"cre":{"id":"function","qualifier":"protected","type":"*","value":function(str){if(!System.is(str,String))System.throwError("type","type of mismatch. must is a String");
return Main.prop("173:26",this,"bb");}},
...
return Main.checkType("177:18",String,'');}}
}}, false);
})();
