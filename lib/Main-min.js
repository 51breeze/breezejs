...
"constructor":function(jj){this["1486289829735"]={"bb":123,"address":"__getter__"};
...
__call__("30:51",console,"log",[jj,' this is a D class ']);var cc=66;},
"implements":[],
"final":false,
"dynamic":false,
...
"constructor":function(){this["1485139948086"]={"dispatcher":null,"age":'3',"classname":"__getter__","name":'666 66fff'};
...
"constructor":function(jj){this["1486289564003"]={"dispatcher":null,"age":'3',"classname":"__getter__","name":'666 66fff'};
...
"constructor":function(target){this["1486287155161"]={"getProxyTarget":null,"storage":null,"forEachCurrentItem":null,"length":null};
Object.constructor.call(this);
...
"constructor":function(jj){this["1486314014005"]={"names":'399999',"uuu":'yhhh',"_home":'ooooo',"home":"__getter__"};
B.constructor.call(this);
var uu,yyyy,hhhh;
var b;
var c;
var i=50;var items=[];var j=i;var a=__newInstance__("42:38",Array,[5,6,8]);__prop__("43:23",a,'name',666);__call__("45:31",a,"push",['yejun']);var cc={"age":100};__prop__("49:20",cc,["age","/="],3);__prop__("50:19",cc,"bb",66666);__call__("51:31",console,"log",[cc]);var o=__newInstance__("55:34",Object);__prop__("57:23",o,'ssss',666);__call__("61:90",console,"log",[a,'=====',__prop__("61:48",a,"length"),__call__("61:61",a,"values"),__call__("61:71",o,"keys"),__call__("61:87",this,"values")]);__call__("65:17",console,"log",['%s',__call__("65:16",a,"find",[function(val){return val===666;}])]);var target=1,index=0;for(c in items){__call__("74:56",console,"log",[__call__("74:41",items,c),'====88888']);}(function(){for(var i=j;i<60;i++){b=i;var hh=i;uu=123,hhhh=6899;yyyy=8888888888;__call__("87:38",console,"log",[hh,i]);if(false){(function(i){var hh;__call__("95:42",console,"log",[jj]);__call__("96:71",items,"push",[function(){return i+'---'+hh;}]);}).call(this,i);}}}).call(this);
__call__("101:33",console,"log",[i,b]);__call__("102:45",this,"tests",[undefined,2,3,4,5,6]);__call__("104:58",console,"log",[System.is(this,IProsess),'==========']);},
"implements":[IProsess],
"final":false,
"dynamic":false,
...
"home":{"id":"function","qualifier":"public","type":"*","value":{get:function(){__call__("113:66",console,"log",[System.is(this,IProsess),' the is getter home']);return __prop__("114:29",this,"_home");}}},
...
var i;
var bb=666;var tests;if(true){(function(){var bb=888;i=9;if(a){}__call__("129:43",console,"log",['===%s',Main]);}).call(this);}__call__("135:40",console,"log",[a,avg,i,bb]);}},
"cre":{"id":"function","qualifier":"protected","type":"*","value":function(str){return __prop__("141:28",this,"bb");}},
