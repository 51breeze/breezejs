...
var __prop__;
var __call__;
B=System.define("com.B",{"constructor":function (){this["1483524916739"]={"six":'man',"__names__":'123'};
__call__("14:23",console,"log",[' this is B']);},"token":"1483524916739","extends":null,"classname":"B","package":"com","implements":[],"final":false,"dynamic":false,"filename":"E:\\nodejs\\breezejs\\lib\\com\\B.as","static":{
"N":{"id":"var","qualifier":"private","type":"*","value":' static var N 123'},
"uuu":{"id":"const","qualifier":"public","type":"*","value":'man'},
"classname":{"id":"var","qualifier":"public","type":"*","value":'man 9999'}
},"proto":{
"six":{"token":1483524916739,"id":"var","qualifier":"public","type":"*","value":'man'},
"__names__":{"token":1483524916739,"id":"var","qualifier":"private","type":"*","value":'123'},
"names":{"id":"function","qualifier":"public","type":String,"value":{get:function (){__call__("20:24",console,"log",[' =====get names======== ',__prop__("20:67",this,"__names__")]);return __prop__("21:34",this,"__names__");},set:function (val){if( typeof val !== "string" )throw new TypeError("Specify the type of mismatch");
__prop__("26:27",this,"__names__",val);}}},
"test":{"id":"function","qualifier":"public","type":"*","value":function (){return '333';}},
"cre":{"id":"function","qualifier":"protected","type":"*","value":function (){return '333';}}
}});
__prop__=B.prop;
__call__=B.call;
})();
...
var Object=System.getDefinitionByName("Object");
var EventDispatcher;
var __prop__;
var __call__;
EventDispatcher=System.define("lib.EventDispatcher",{"constructor":function (target){Object.constructor.call(this);
this["1483946649562"]={"getProxyTarget":null,"storage":null,"forEachCurrentItem":null,"length":null};
__prop__("34:48",this,'getProxyTarget'||__prop__("34:48",this,"length"));__prop__("35:31",this,"getProxyTarget",target&&1?function (){return __prop__("37:40",target,"length")>0?target:[this];}:function (){return __prop__("40:50",this,"forEachCurrentItem")?[__prop__("40:77",this,"forEachCurrentItem")]:(__prop__("40:94",this,"length")>0?this:[this]);});},"token":"1483946649562","extends":Object,"classname":"EventDispatcher","package":"lib","implements":[],"final":false,"dynamic":false,"filename":"E:\\nodejs\\breezejs\\lib\\lib\\EventDispatcher.as","static":{
"Listener":{"id":"var","qualifier":"public","type":Class,"value":B},
"SpecialEvent":{"id":"var","qualifier":"public","type":Class,"value":B}
},"proto":{
"getProxyTarget":{"token":1483946649562,"id":"var","qualifier":"private","type":Function,"value":null},
"storage":{"token":1483946649562,"id":"var","qualifier":"private","type":Function,"value":null},
"forEachCurrentItem":{"token":1483946649562,"id":"var","qualifier":"private","type":"*","value":null},
"length":{"token":1483946649562,"id":"var","qualifier":"private","type":"*","value":null},
"hasEventListener":{"id":"function","qualifier":"public","type":"*","value":function (type){var target=__call__("46:43",this,"getProxyTarget"),index=0;while (index<target){var events=__call__("50:46",this,["storage","call"],[__prop__("50:61",target,index)]);if (events&&__prop__("51:41",events,type)){return true;}index++;}__call__("57:23",console,"log",[System.instanceof(this,EventDispatcher),'====is even ====']);return false;}},
"addEventListener":{"id":"function","qualifier":"public","type":System.define("lib.EventDispatcher"),"value":function (type,callback,useCapture,priority,reference){var len=__prop__("70:31",type,"length");if (System.instanceof(type,Array)){while (len>0)__call__("75:53",this,"addEventListener",[__prop__("75:65",type,--len),callback,useCapture,priority,reference]);return this;}if (System.typeof("79:27",type)!=='string'){throw System.new("81:31",Error,['invalid event type.']);}var target=__call__("84:43",this,"getProxyTarget"),index=0;var listener=System.new("86:53",EventDispatcher,"Listener",[callback,useCapture,priority,reference]);var bindBeforeProxy;while (index<__prop__("89:41",target,"length")){__prop__("91:35",listener,"dispatcher",this);__prop__("92:38",listener,"currentTarget",__prop__("92:51",target,index));__prop__("93:29",listener,"type",type);if (!(System.instanceof(__prop__("94:42",bindBeforeProxy,type),__prop__("94:83",EventDispatcher,"SpecialEvent")))||!__call__("95:56",bindBeforeProxy,[type,"callback","call"],[this,listener])){}index++;}return this;}},
"removeEventListener":{"id":"function","qualifier":"public","type":"*","value":function (type,listener){var target=__call__("114:43",this,"getProxyTarget");var b=0;var removeEventListener;while (b<__prop__("117:36",target,"length")){__call__("119:40",removeEventListener,"call",[__prop__("119:49",target,b),type,listener,this]);b++;}return true;}},
"dispatchEvent":{"id":"function","qualifier":"public","type":"*","value":function (event){var BreezeEvent;var dispatchEvent;if (!(System.instanceof(event,BreezeEvent))){throw System.new("136:31",Error,['invalid event.']);}var target=__prop__("137:46",this,'getProxyTarget');var targets=__call__("138:53",this,'getProxyTargets',[998]);var i=0;var element;__call__("141:18",target);while (i<__prop__("142:36",target,"length")&&!__prop__("142:65",event,"propagationStopped")){element=__prop__("144:35",target,i);__prop__("145:35",event,"currentTarget",element);__prop__("146:28",event,"target",__prop__("146:43",event,"target")||element);__call__("147:29",dispatchEvent,[event]);i++;}return !__prop__("150:44",event,"propagationStopped");}}
}});
...
var B=System.getDefinitionByName("com.B");
var Main;
var __prop__;
var __call__;
Main=System.define("Main",{"constructor":function (){B.constructor.call(this);
this["1483948661125"]={"name":'665888',"age":35,"storage":function (){},"dispatcher":null};
var ii={"name":{},"age":1};__prop__("45:22",this,["age","+="],6);__prop__("47:29",this,"dispatcher",System.new("47:51",EventDispatcher));__call__("50:25",console,"log",[__prop__("50:36",this,"name")+'666','========']);__call__("51:25",console,"log",[__prop__("51:35",this,"age")]);__call__("53:25",console,"log",[System.is(this,B),'====is B ====']);__call__("56:25",console,"log",[__call__("56:60",this,["dispatcher","hasEventListener"],['jjj'])]);var b,c='uuuu',d=6;var name=null;__call__("61:24",console,"log",[__prop__("61:37",B,"classname")]);__call__("62:25",console,"log",[__prop__("62:36",Main,"name")]);},"token":"1483948661125","extends":B,"classname":"Main","package":"","implements":[],"final":false,"dynamic":false,"filename":"E:\\nodejs\\breezejs\\lib\\Main.as","static":{
"name":{"id":"var","qualifier":"private","type":Number,"value":5}
},"proto":{
"name":{"token":1483948661125,"id":"var","qualifier":"private","type":String,"value":'665888'},
"age":{"token":1483948661125,"id":"var","qualifier":"private","type":Number,"value":35},
"storage":{"token":1483948661125,"id":"var","qualifier":"private","type":Function,"value":function (){}},
"dispatcher":{"token":1483948661125,"id":"var","qualifier":"private","type":EventDispatcher,"value":null}
}});
__prop__=Main.prop;
__call__=Main.call;
})();
