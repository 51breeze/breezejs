(function(){
var System = (function(_Object,_String,_Array,_Error, undefined )
{
    var system={};
    var globals={};
    var packages={};
    ...
    function Object( value )
    {
        ...
        if ( !(this instanceof Object) )return new system.Object(value);
     ...
     * @constructor
     */
    system.Interface = function Interface()
    {
        Object.call(this);
        return this;
    }
     ...
     * @returns {boolean}
     */
    system.instanceof=function(instanceObj, theClass)
    {
        ...
        var type = system.typeof( instanceObj );
        switch ( type )
        {
     ...
     * @returns {boolean}
     */
    system.is=function(instanceObj, theClass)
    {
        var isclass = theClass instanceof Class;
        var isInterface = theClass instanceof Interface;
        if( isclass || isInterface )
    ...
    system.define=function(name , descriptor , isInterface)
    {
