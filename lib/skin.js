...
function makeModuleClass(config, classModule, attr, components, scriptContent ,styleContent, superParam ,paramName )
{
    var imports = ['breeze.components.ComponentEvent'];
    var body=[];
