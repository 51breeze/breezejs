var descriptor = {
    ...
    'DataSource':{
        ...
        'proto':{
            ...
            'preloadPages':{'type':'Number','id':'function','param':[]},
            'rows':{'type':'Number','id':'function','param':[]},
            'preloadRows':{'type':'Number','id':'function','param':[]},
            'predicts':{'type':'Number','id':'function','param':[]},
            'grep':{'type':'DataGrep','id':'function','param':[]},
            'where':{'type':'DataSource','id':'function','param':[]},
            'currentPage':{'type':'Number','id':'function','param':[]},
            'segments':{'type':'Number','id':'function','param':[]},
            'totalPages':{'type':'Number','id':'function','param':[]},
            'offsetAt':{'type':'Number','id':'function','param':[]},
            'append':{'type':'DataSource','id':'function','param':[]},
